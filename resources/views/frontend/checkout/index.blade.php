		...
		<div class="content">
            ...
            <form action="{{ url('/customer/details/for-order') }}" method="post">
				...
				<div class="container">
					 ...
					 <div class="cart-header">
                      ...
                      <tr>
                            ...
                            <form action="{{ url('/cart/product/update/'.$cartProduct->id) }}" method="post">
                                @csrf
                                <input type='number' name="qty" value="{{$totalQty= $cartProduct->qty}}"/><button type="submit" name="btn" class="btn btn-sm btn-success">
                               Update</button>
                            </form></td>
                    ...
                    <h2>
                        <center> Shipping & Billing Information </center> </h2>
                    <hr/>
                    <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="form-group">
                            <label>Address</label>
                            <textarea class="form-control" name="address" placeholder="Enter Customer adddress">{{ auth()->check() ? auth()->user()->address: old('addresss')}}</textarea>
                        </div>
