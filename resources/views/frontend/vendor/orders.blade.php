...
<div class="banner1">
 ...
 <ul>
    ...
    <li><a href="{{ url('/vendor/pending/product') }}">Pending Products</a></li>
    <li><a href="{{ url('/vendor/approved/product') }}">Approved products</a></li>
 </ul>
...
<tr>
                <td>{{ $loop->index+1 }}</td>
                <td><img src="{{ asset('/product/'.$order->product->image) }}" height='50' width='50'/></td>
